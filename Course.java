...
public class Course {
    ...
    /** title of the course (e.g. “Intro to programming”);
     * 
     */
    private String code; 
    /** course code, e.g. SOFE, ELEE, MANE, etc.
     * 
     */
    private int number; 
    /** course number, e.g. 1200, 2710, 2800, etc.
     * 
     */
    Vector<Student> classList; 
    /** contains all students registered in this course
     * 
     * @return
     */
